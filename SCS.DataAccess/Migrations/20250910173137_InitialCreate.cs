    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "[\"2025-09-21\",\"2025-09-23\"]", null, new DateOnly(2025, 9, 24), "Sanctions", false, new DateOnly(2025, 9, 20) },
                    { 2, "[\"2025-10-01\",\"2025-10-04\",\"2025-10-06\"]", null, new DateOnly(2025, 10, 9), "C# Beginner", false, new DateOnly(2025, 9, 30) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateOnly(2025, 9, 20), false },
                    { 2, 1, new DateOnly(2025, 9, 21), true },
                    { 3, 1, new DateOnly(2025, 9, 22), false },
                    { 4, 1, new DateOnly(2025, 9, 23), true },
                    { 5, 1, new DateOnly(2025, 9, 24), false },
                    { 6, 2, new DateOnly(2025, 9, 30), false },
                    { 7, 2, new DateOnly(2025, 10, 1), true },
                    { 8, 2, new DateOnly(2025, 10, 2), false },
                    { 9, 2, new DateOnly(2025, 10, 3), true },
                    { 10, 2, new DateOnly(2025, 10, 4), true },
                    { 11, 2, new DateOnly(2025, 10, 5), false },
                    { 12, 2, new DateOnly(2025, 10, 6), true },
                    { 13, 2, new DateOnly(2025, 10, 7), false },
                    { 14, 2, new DateOnly(2025, 10, 8), false },
                    { 15, 2, new DateOnly(2025, 10, 9), false }
                });
