...
namespace SCS.DataAccess.Migrations
{
    ...
    [Migration("20241102161220_newMigration")]
            ...
            modelBuilder.Entity("SCS.Models.CertificationSlot", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Dates = "[\"2024-11-13\",\"2024-11-15\"]",
                            EndDate = new DateOnly(2024, 11, 16),
                            Name = "Sanctions",
                            ShowDays = false,
                            StartDate = new DateOnly(2024, 11, 12)
                        },
                        new
                        {
                            Id = 2,
                            Dates = "[\"2024-11-23\",\"2024-11-26\",\"2024-11-28\"]",
